...
Option4 : 1.  './testResources/testExecutionFiles/ExperienceApp/'
          2. './testResources/testExecutionFiles/ExperienceApp/*'
          3. './testResources/testExecutionFiles/ExperienceApp,./testResources/testExecutionFiles/difusion'
          4. './testResources/testExecutionFiles/ExperienceApp/*,./testResources/testExecutionFiles/difusion/*'

Option5 : 1. './testResources/testExecutionFiles/ExperienceApp/userOnboardingTest.json'
          2. './testResources/testExecutionFiles/ExperienceApp/*.json'
          3. './testResources/testExecutionFiles/ExperienceApp/land*.json'
          4. './testResources/testExecutionFiles/ExperienceApp/land*.json,./testResources/testExecutionFiles/ExperienceApp/etext*.json'
-----------------------------------------------------------------------------------------------------------*/

'use strict';
// argv.testExecFile = 'etextFeatureTest.json,tocFeatureTest.json,dashboardFeatureTest.json'
// argv.excludeTestFile = './testResources/testExecutionFiles/ExperienceApp/etext*.json'
        ...
        specFiles.forEach(function (testSpec) {
            ...
            //else if pathProps.dir is valid and it exists
                ...
                //check if pathProps.base is a file name with wildcard character (*)
                    ...
                    //Option4 : 2. './testResources/testExecutionFiles/ExperienceApp/*'
                    //          4. './testResources/testExecutionFiles/ExperienceApp/*,./testResources/testExecutionFiles/difusion/*'
